...
public class AsignarComprador extends Command {
    ...
    public AsignarComprador(IdPedido idPedido, IdComprador idComprador, DatosPersona datosComprador, Tarjeta tarjetaComprador) {
