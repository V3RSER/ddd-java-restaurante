...
public class ActualizarOrden extends Command {
    ...
    public ActualizarOrden(IdPedido idPedido, IdOrden idOrden, DatosEnvio datosEnvio, Set<DatosComida> datosComidas, NombrePersona nombreComprador) {
