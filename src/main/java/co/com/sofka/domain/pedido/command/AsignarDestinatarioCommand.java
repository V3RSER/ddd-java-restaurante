...
public class AsignarDestinatarioCommand extends Command {
    ...
    public AsignarDestinatarioCommand(IdPedido idPedido, IdDestinatario idDestinatario, DatosPersona datosDestinatario, Direccion direccionDestinatario, Dinero efectivoDestinatario) {
