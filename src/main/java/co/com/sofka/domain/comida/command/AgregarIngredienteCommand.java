...
public class AgregarIngredienteCommand extends Command {
    private final IdComida idComida;
    private final IdIngrediente idIngrediente;
    private final Nombre nombre;
    private final Descripcion descripcion;

    public AgregarIngredienteCommand(IdComida idComida, IdIngrediente idIngrediente, Nombre nombre, Descripcion descripcion) {
