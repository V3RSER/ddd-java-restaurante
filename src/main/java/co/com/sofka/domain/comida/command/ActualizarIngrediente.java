...
public class ActualizarIngrediente extends Command {
    private final IdComida idComida;
    private final IdIngrediente idIngrediente;
    private final Nombre nombre;
    private final Descripcion descripcion;

    public ActualizarIngrediente(IdComida idComida, IdIngrediente idIngrediente, Nombre nombre, Descripcion descripcion) {
