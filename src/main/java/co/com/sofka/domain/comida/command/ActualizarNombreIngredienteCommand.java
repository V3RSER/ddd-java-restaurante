...
public class ActualizarNombreIngredienteCommand extends Command {
    private final IdComida idComida;
    private final IdIngrediente idIngrediente;
    private final Nombre nombre;

    public ActualizarNombreIngredienteCommand(IdComida idComida, IdIngrediente idIngrediente, Nombre nombre) {
