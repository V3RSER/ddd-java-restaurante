...
public class ActualizarDescripcionIngredienteCommand extends Command {
    private final IdComida idComida;
    private final IdIngrediente idIngrediente;
    private final Descripcion descripcion;

    public ActualizarDescripcionIngredienteCommand(IdComida idComida, IdIngrediente idIngrediente, Descripcion descripcion) {
