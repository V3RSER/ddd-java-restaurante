...
public class AsignarPedidoCommand extends Command {
    private final IdRepartidor idRepartidor;
    private final IdPedido idPedido;
    private final DatosEnvio datosEnvio;
    private final Dimensiones dimensiones;

    public AsignarPedidoCommand(IdRepartidor idRepartidor, IdPedido idPedido, DatosEnvio datosEnvio, Dimensiones dimensiones) {
